...
public class TelaAdmin extends javax.swing.JFrame {
    ...
    public TelaAdmin() {
        initComponents();
        textAreaUser.setContentType("text/html");
...
//aqui esta carregando os livros cadastrados 
        ...
        try {
            ...
            for (Usuario usuario : usuarios) {
                sb.append("<p style='font-family:Verdana, sans-serif; font-size:12px;'>")
                   ...
                   .append("<hr style='border:1px dashed #bbb;'>")
                   .append("</p>");
            }
            sb.append("</body></html>");
            textAreaUser.setContentType("text/html");
            ...
            e.printStackTrace();
            javax.swing.JOptionPane.showMessageDialog(this, "Erro ao carregar usuários: " + e.getMessage());
        }
    }
    ...
    private void initComponents() {
        ...
        btnGerencUser = new javax.swing.JButton();
        ...
        textAreaUser = new javax.swing.JEditorPane();
        ...
        btnGerencUser.setBackground(new java.awt.Color(255, 153, 31));
        btnGerencUser.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        btnGerencUser.setForeground(new java.awt.Color(255, 255, 255));
        btnGerencUser.setText("Gerenciar usuário");
        btnGerencUser.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGerencUserActionPerformed(evt);
            }
        });
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addGap(70, 70, 70)
                .addComponent(btnGerencUser, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
        ...
        TextAreaLivros.setEditable(false);
        TextAreaLivros.setBackground(new java.awt.Color(255, 255, 255));
        TextAreaLivros.setContentType("text/html\n"); // NOI18N
        jScrollPane2.setViewportView(TextAreaLivros);

        jScrollPane4.setViewportView(jScrollPane2);

        textAreaUser.setEditable(false);
        textAreaUser.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnGerencUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerencUserActionPerformed
        TelaGerenciarUser telaGerenciarUser = new TelaGerenciarUser();
        telaGerenciarUser.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnGerencUserActionPerformed
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        TelaBuscaLivro telaBusca = new  TelaBuscaLivro();
    ...
    private javax.swing.JButton btnGerencUser;
    ...
    private javax.swing.JEditorPane textAreaUser;
